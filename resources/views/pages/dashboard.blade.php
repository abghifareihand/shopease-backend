        ...
        <div class="card border-0 zoom-in bg-info-subtle shadow-none">
          <div class="card-body">
            <div class="text-center">
              ...
              <h5 class="fw-semibold text-info mb-0"> {{ $totalAllUser }}</h5>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card border-0 zoom-in bg-success-subtle shadow-none">
          <div class="card-body">
            <div class="text-center">
              ...
              <h5 class="fw-semibold text-success mb-0">{{ $totalAdmin }}</h5>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
          <div class="card-body">
            <div class="text-center">
              ...
              <h5 class="fw-semibold text-danger mb-0">{{ $totalUser }}</h5>
            </div>
          </div>
        </div>
      </div>
